...
namespace Sgry.Ann
{
    class AnnForm2 : Form
    {
        ...
        System.Windows.Forms.Timer _TimerForDelayedActivatedEvent = new System.Windows.Forms.Timer();
        ...
        void InitUIComponent()
        {
            ...
            // _MI_File
            //
            _MI_File.DropDownOpening += _MI_File_Popup;
            //
            // _MI_Edit
            //
            _MI_Edit.DropDownOpening += _MI_Edit_Popup;
            //
            // _MI_Window
            //
            _MI_Window.DropDownOpening += _MI_Window_Popup;
            //
            // AnnForm
            // 
...
class AnnMenuRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
            ...
            using (var brush = new SolidBrush(textColor))
            {
                ...
                {
                    // ショートカット文字列
                    string shortcut = item.ShortcutKeyDisplayString;
                    if (string.IsNullOrEmpty(shortcut))
                        shortcut = TypeDescriptor.GetConverter(typeof(Keys)).ConvertToString(item.ShortcutKeys);
                    ...
                    // 左テキスト
                    e.Graphics.DrawString(item.Text, e.TextFont, brush, rect, sfLeft);

                    // 右ショートカット
                    e.Graphics.DrawString(shortcut, e.TextFont, brush, rect, sfRight);
                }
                else
                {
                    // ショートカットなしの通常項目
        ...
        {
            _MainMenu.Renderer = new AnnMenuRenderer();// ToolStripSystemRenderer();
            ...
            // other menu settings
            _MI_Edit_EolCode_CRLF.CheckOnClick = true;
            _MI_Edit_EolCode_LF.CheckOnClick = true;
            _MI_Edit_EolCode_CR.CheckOnClick = true;

            // bind menu actions
            EventHandler menuActionHandler = this.HandleMenuAction;
            foreach (ToolStripMenuItem mi in _MainMenu.Items)
            {
                foreach (Object mi2 in mi.DropDownItems)
                {
                    if (!(mi2 is ToolStripMenuItem)) continue;

                    foreach (ToolStripMenuItem mi3 in ((ToolStripMenuItem)mi2).DropDownItems)
                    {
                    ...
                    ((ToolStripMenuItem)mi2).Click += menuActionHandler;
                }
            }
        ...
        MenuStrip _MainMenu = new();
        ToolStripMenuItem _MI_File = new();
        ToolStripMenuItem _MI_File_New = new();
        ToolStripMenuItem _MI_File_Open = new();
        ToolStripMenuItem _MI_File_Save = new();
        ToolStripMenuItem _MI_File_SaveAs = new();
        ToolStripMenuItem _MI_File_Encoding = new();
        ToolStripMenuItem _MI_File_Encoding_Auto = new();
        ToolStripMenuItem _MI_File_Encoding_SJIS = new();
        ToolStripMenuItem _MI_File_Encoding_JIS = new();
        ToolStripMenuItem _MI_File_Encoding_EUCJP = new();
        ToolStripMenuItem _MI_File_Encoding_UTF8 = new();
        ToolStripMenuItem _MI_File_Encoding_UTF8B = new();
        ToolStripMenuItem _MI_File_Encoding_UTF16LE = new();
        ToolStripMenuItem _MI_File_Encoding_UTF16LEB = new();
        ToolStripMenuItem _MI_File_Encoding_UTF16BE = new();
        ToolStripMenuItem _MI_File_Encoding_UTF16BEB = new();
        ToolStripMenuItem _MI_File_Close = new();
        ToolStripSeparator _MI_File_Sep1 = new ToolStripSeparator();
        ToolStripMenuItem _MI_File_ReadOnly = new();
        ToolStripMenuItem _MI_File_OpenSettingsFile = new();
        ToolStripSeparator _MI_File_Sep2 = new ToolStripSeparator();
        ToolStripMenuItem _MI_File_Mru = new();
        ToolStripSeparator _MI_File_Sep3 = new ToolStripSeparator();
        ToolStripMenuItem _MI_File_Exit = new();
        ToolStripMenuItem _MI_Edit = new();
        ToolStripMenuItem _MI_Edit_Undo = new();
        ToolStripMenuItem _MI_Edit_Redo = new();
        ToolStripSeparator _MI_Edit_Sep0 = new();
        ToolStripMenuItem _MI_Edit_Cut = new();
        ToolStripMenuItem _MI_Edit_Copy = new();
        ToolStripMenuItem _MI_Edit_Paste = new();
        ToolStripSeparator _MI_Edit_Sep1 = new();
        ToolStripMenuItem _MI_Edit_Find = new();
        ToolStripMenuItem _MI_Edit_FindNext = new();
        ToolStripMenuItem _MI_Edit_FindPrev = new();
        ToolStripSeparator _MI_Edit_Sep2 = new();
        ToolStripMenuItem _MI_Edit_SelectAll = new();
        ToolStripMenuItem _MI_Edit_GotoLine = new();
        ToolStripSeparator _MI_Edit_Sep3 = new();
        ToolStripMenuItem _MI_Edit_EolCode = new();
        ToolStripMenuItem _MI_Edit_EolCode_CRLF = new();
        ToolStripMenuItem _MI_Edit_EolCode_LF = new();
        ToolStripMenuItem _MI_Edit_EolCode_CR = new();
        ToolStripMenuItem _MI_Edit_BlankOp = new();
        ToolStripMenuItem _MI_Edit_BlankOp_TrimTrailingSpace = new();
        ToolStripMenuItem _MI_Edit_BlankOp_TrimLeadingSpace = new();
        ToolStripMenuItem _MI_Edit_BlankOp_ConvertTabsToSpaces = new();
        ToolStripMenuItem _MI_Edit_BlankOp_ConvertSpacesToTabs = new();
        ToolStripMenuItem _MI_View = new();
        ToolStripMenuItem _MI_View_ShowSpecialChar = new();
        ToolStripMenuItem _MI_View_WrapLines = new();
        ToolStripMenuItem _MI_View_ShowTabPanel = new();
        ToolStripMenuItem _MI_Mode = new();
        ToolStripMenuItem _MI_Mode_Text = new();
        ToolStripMenuItem _MI_Mode_BatchFile = new();
        ToolStripMenuItem _MI_Mode_Cpp = new();
        ToolStripMenuItem _MI_Mode_CSharp = new();
        ToolStripMenuItem _MI_Mode_Diff = new();
        ToolStripMenuItem _MI_Mode_Ini = new();
        ToolStripMenuItem _MI_Mode_Java = new();
        ToolStripMenuItem _MI_Mode_JavaScript = new();
        ToolStripMenuItem _MI_Mode_Latex = new();
        ToolStripMenuItem _MI_Mode_Python = new();
        ToolStripMenuItem _MI_Mode_Ruby = new();
        ToolStripMenuItem _MI_Mode_XML = new();
        ToolStripMenuItem _MI_Window = new();
        ToolStripMenuItem _MI_Window_Next = new();
        ToolStripMenuItem _MI_Window_Prev = new();
        ToolStripMenuItem _MI_Window_List = new();
        ToolStripMenuItem _MI_Help = new();
        ToolStripMenuItem _MI_Help_MemoryUsage = new();
        ToolStripMenuItem _MI_Help_About = new();
        AzukiControl _Azuki;
